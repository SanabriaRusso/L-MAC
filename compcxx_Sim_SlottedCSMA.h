...
typedef void  (compcxx_component::*Channel_out_slot_f_t)(SLOT_notification &slot);
typedef void  (compcxx_component::*BatchPoissonSource_out_f_t)(Packet &packet);
typedef void  (compcxx_component::*STA_out_packet_f_t)(Packet &packet);
};
