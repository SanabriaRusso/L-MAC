...
set ylabel "Seconds between successful transmissions" 
...
GNUTERM = "aqua"
plot "processed.txt" u 1:($42) title "avg. Time between SxTx: BK" w l ls 2 lw 2, "" u 1:($44) title "avg. Time between SxTx: BE" w l ls 3 lw 2, "" u 1:($46) title "avg. Time between SxTx: VI" w l ls 4 lw 2, "" u 1:($48) title "avg. Time between SxTx: VI" w l ls 5 lw 2
#    EOF
