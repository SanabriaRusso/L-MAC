...
GNUTERM = "aqua"
plot "processed_toPlot.txt" u 1:($2/1e6) title "Overall throughput" w l ls 1 lw 2, "" u 1:($4/1e6) title "Background" w l ls 2 lw 2, "" u 1:($6/1e6) title "Best effort" w l ls 3 lw 2, "" u 1:($8/1e6) title "Video" w l ls 4 lw 2, "" u 1:($10/1e6) title "Voice" w l ls 5 lw 2
#    EOF
