...
set xrange [ 2.00000 : * ] noreverse nowriteback
...
GNUTERM = "aqua"
plot "processed.txt" u 1:($32) title "Overall Fairness" w l ls 1 lw 2, "" u 1:($34) title "Background" w l ls 2 lw 2, "" u 1:($36) title "Best effort" w l ls 3 lw 2, "" u 1:($38) title "Video" w l ls 4 lw 2, "" u 1:($40) title "Voice" w l ls 5 lw 2
#    EOF
